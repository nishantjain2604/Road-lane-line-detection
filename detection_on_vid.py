...
cap = cv2.VideoCapture(r"F:\M.tech\internship\road-lane-detection-master\Data\lane_vid2.mp4")

frame_width = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))
frame_height = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
fourcc = cv2.VideoWriter_fourcc(*"XVID")
saved_frame = cv2.VideoWriter(r"F:\M.tech\internship\road-lane-detection-master\Data\lane_detection.avi", fourcc, 30.0, (frame_width, frame_height))
